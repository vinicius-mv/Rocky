...
namespace Rocky.DataAccess.Migrations
{
    ...
    [Migration("20211008020217_AddTableOrderDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rocky.Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rocky.Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rocky.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rocky.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Rocky.Models.InquiryDetail", b =>
                {
                    b.HasOne("Rocky.Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Rocky.Models.InquiryHeader", b =>
                {
                    b.HasOne("Rocky.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Rocky.Models.OrderDetail", b =>
                {
                    b.HasOne("Rocky.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Rocky.Models.OrderHeader", b =>
                {
                    b.HasOne("Rocky.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
